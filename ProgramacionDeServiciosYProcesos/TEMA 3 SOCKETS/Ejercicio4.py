# Ejercicio 4: El servidor genera un número secreto aleatorio (por ejemplo, entre 1 y 100). Un cliente se conecta y envía intentos. El servidor responde si el número es:
# "Muy alto"
# "Muy bajo"
# "Correcto”
